...
//            self::$objInstance = new TemplaterBlitz();
            echo 'x'; 
            $objTwigLoader = new \Twig_Loader_Filesystem();
            echo 'x'; exit();
            self::$objInstance = new \Twig_Environment($objTwigLoader, array(
...
//class SubTwig extends \Twig implements \webcitron\Subframe\ITemplaterHelper {
//    
//    
//    /**
//     * @return string
